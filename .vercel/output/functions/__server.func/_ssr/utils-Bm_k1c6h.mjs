...
//#region node_modules/.nitro/vite/services/ssr/assets/utils-Bm_k1c6h.js
var COMPANY = {
...
var PROCESS = [
	{
		step: "01",
		title: "Discover",
		body: "We learn your business, your goals, and the constraints that matter."
	},
	{
		step: "02",
		title: "Design",
		body: "We scope the solution and agree on timeline, approach, and budget together."
	},
	{
		step: "03",
		title: "Build",
		body: "We develop in the open, with regular check-ins so there are no surprises."
	},
	{
		step: "04",
		title: "Support",
		body: "We stay reachable after launch for fixes, updates, and future growth."
	}
];
var SKILL_GROUPS = [
	{
...
var TEAM = [
	{
		...
		certs: [
			...
			{
				title: "Google",
				items: ["Google Cloud Certified – Professional Cloud Developer (PR000266)", "Google Cloud Certified – Professional Cloud Architect (PR000213)"]
			},
			{
				title: "Other",
				items: [
	...
	},
	{
		...
		skills: [
			...
			{
				title: "Languages",
				tags: ["Bangla (Native)", "English (Professional)"]
			}
		]
	},
	{
...
//#endregion
export { PROCESS as a, TEAM as c, cn as d, getEmployee as f, PORTFOLIO as i, VALUES as l, MARQUEE as n, SERVICES as o, NAV as r, SKILL_GROUPS as s, COMPANY as t, WHY as u };
